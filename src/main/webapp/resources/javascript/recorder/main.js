...
//  Embedding flash object ---------------------------------------------------------------------------------------------
  ...
  var appWidth = 1;
  var appHeight = 1;
  var flashvars = {'upload_image': 'images/recorder/upload.png'};
  var params = {};
  var attributes = {'id': "recorderApp", 'name': "recorderApp"};
  swfobject.embedSWF("resources/javascript/recorder/recorder.swf", "flashcontent", appWidth, appHeight, "11.0.0", "", flashvars, params, attributes);
   ...
   // $('#status').text("Last recorder event: " + arguments[0]);
    ...
    switch (arguments[0]) {
      ...
      case "microphone_level":
        $level.css({width: arguments[1] * 100 + '%'});
        break;
