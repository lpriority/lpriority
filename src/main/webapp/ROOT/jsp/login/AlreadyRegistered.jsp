	...
	<div class="form" style="margin-top:-1em;">
      	<div id="ftui">   
        	<h1>Email Verification</h1>
          		<div>
                	<span>You have already registered please login with the credentials. if you forget 
               your
                password please click on <a href="forgotPassword.htm" >Forgot my Password</a>.</span>
              	</div>
              	<div>
