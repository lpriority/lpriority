...
<body>
	<table>
		...
		<c:forEach items="${stList}" var="stList">
			<tr>
				<td>${stList.schoolTypeId}</td>
				<td>${stList.schoolTypeName}</td>
				<td><a href="editSchoolType.htm?id=${stList.schoolTypeId}"><img
						src="images/Admin/edit_button.png" width="30" height="30"></a></td>
				<td>&nbsp;</td>
				<td><img src="images/Admin/delete_button.png" width="40" height="30" onclick="deleteSchoolType()"></td>
			</tr>
		</c:forEach>
		<tr>
			<td><a href="addSchoolType.htm"><img
