...
<body>
	<table>
		...
		<c:forEach items="${statesList}" var="sList">
			<tr>
				<td>${sList.stateId}</td>
				<td>${sList.name}</td>
				<td>${sList.country.country}</td>
				<td><a href="editState.htm?id=${sList.stateId}"><img
						src="images/Admin/edit_button.png" width="30" height="30"></a></td>
				<td>&nbsp;</td>
				<td><img
						src="images/Admin/delete_button.png" width="40" height="30" onclick="deleteState()"></td>
			</tr>
		</c:forEach>
		<tr>
			<td><a href="addState.htm"><img
