	...
	<table>
		...
		<c:forEach items="${iList}" var="il">
			<tr>
				<td>${il.interestId}</td>
				<td>${il.interest}</td>
				<td><a href="editInterest.htm?id=${il.interestId}"><img
						src="images/Admin/edit_button.png" width="30" height="30"></a></td>
				<td>&nbsp;</td>
				<td><img src="images/Admin/delete_button.png" width="40" height="30" onclick="deleteInterest()"></td>
			</tr>
		</c:forEach>
		<tr>
			<td><a href="addInterest.htm"><img
