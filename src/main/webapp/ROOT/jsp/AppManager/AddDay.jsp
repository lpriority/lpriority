...
<body>
	<form:form id="DaysForm" modelAttribute="day"
		action="saveDay.htm">
		<!--  method="post"-->
		<table>
			<tr>
				<td><form:label path="day">* Day:</form:label></td>
				<td><form:input path="day" /> <font color="red"> <form:errors path="day"></form:errors></font></td>
			</tr>
			<tr>
				<td><form:hidden path="dayId" /></td>
			</tr>
			<tr>
