...
<table border="${bor}" class="${de}"><tr><td>
 ...
 <table>
           ...
           <tr><td height=10 colSpan=30></td></tr> 
            ...
            <c:forEach items="${studentAssignmentStatusLt}" var="sas" varStatus="status">
                    ...
                    <c:choose>
	                    ...
	                    <c:when test="${sas.assignment.assignmentType.assignmentType == 'Fluency Reading' or sas.assignment.assignmentType.assignmentType == 'Accuracy Reading'}">
	                    	<input type="radio" class="radio-design" name="radio" id="studentAssignmentId${testCount}" value="${sas.studentAssignmentId}"  onClick="getFluencyAndAccuracyQuestions(${sas.assignment.assignmentId},${sas.studentAssignmentId},${sas.assignment.assignmentType.assignmentTypeId})" />
	                    	<label for="studentAssignmentId${testCount}" class="radio-label-design"></label>
	                    </c:when>
	                    <c:otherwise>
	                         <input type="radio" class="radio-design" name="radio" id="studentAssignmentId:${testCount}" onClick="getStudentRTITestResult(${sas.assignment.assignmentId},${sas.studentAssignmentId},${sas.assignment.assignmentType.assignmentTypeId},'${sas.status}',${testCount})" />
	                   		 <label for="studentAssignmentId:${testCount}" class="radio-label-design"></label>
	                    </c:otherwise>
                    </c:choose>
                    ...
                    <td width='141'  align='center' valign='middle' class='txtStyle'>
                      <c:choose>
                       ...
                       <td>	<div id='dialog${status.count}'  style="display:none;overflow-y:auto; overflow-x:hidden;background : #f7f5f5 url('images/Common/bg.jpg') repeat fixed top center;"  title=''>
		                	<iframe id='iframe${status.count}' width="95%" height="95%"></iframe></div>
		                	<!--  <div id="dialog"  style="display:none;overflow-y:auto; overflow-x:hidden;" title=""><iframe  id ="iframe" src="" width="100%" height="95%" src=""  style=""></iframe></div> -->
		               </td>
                    </tr>
     ...
     <table width='100%' height='25' border='0' cellpadding='0' cellspacing='0'>
                ...
                <tr><td align="center" valign='middle' id="returnMessage">
	...
	<div id="performanceDailog"></div></tr></table>
</body>
</html>