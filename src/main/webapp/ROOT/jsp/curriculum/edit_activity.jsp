...
<script>
	...
	function changeMe(){
		...
		var activeContainer = $(document.getElementById('activeDiv'));
		...
		if(lessonId > 0 && classId > 0){			
	        $.ajax({  
				url : "editActivityView.htm", 
				data: "lessonId=" + lessonId, 
		       	success : function(data) { 
		       		$(activeContainer).append(data);
		       	}  
		    }); 
		}else{
...
<form:form id="editActivity"  action="updateActivity.htm" modelAttribute="editActivity" method="post">
	<table width="100%" height="100%" border=0 align="center" cellPadding=0 cellSpacing=0>
                        <tr>
                            	...
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="padding-left: 8em;"> 
                                                    ...
                                                    <tr>
                                                        <td height="20" align="left" class="label" style="width: 12em;">Grade &nbsp;&nbsp;&nbsp;
                                                            <select name="gradeId" class="listmenu" id="gradeId" onChange="loadClasses();clearDiv();">
                                                        ...
                                                        <td height="20" class="label" style="width: 13em;padding-left: 2em;">Subject &nbsp;&nbsp;&nbsp;
															<select id="classId" name="classId" class="listmenu" onChange="clearDiv();loadGradeClassLessons();">
																<option value="select">select subject</option>
															</select>
														</td>
														<td height="20" class="label" style="padding-left: 2em;">Lesson &nbsp;&nbsp;&nbsp;
															<select id="lessonId" name="lessonId" class="listmenu" onChange="changeMe()">
