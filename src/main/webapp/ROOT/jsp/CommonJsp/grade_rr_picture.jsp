...
<tr >
	<td align="center" colspan="2">
		<table>
			<tr><td align="center" colspan="3"><div id="contentDiv" >
		    <img class="imgCls" style="width: 70px; height: 70px; border-radius: 50%;"
			 onclick="openPreviewImage()" src="loadUserFile.htm?regId=${activityScore.student.userRegistration.regId}&usersFilePath=${usersFilePath}"> 
			</div></td></tr>
			<tr>
				...
				<td width="35%" height="20" align="left" valign="middle"><span class="tabtxt"> 
			...
			<tr>
				...
				<td width="10%" height="20" align="center" valign="middle">:</td>
				<td width="35%" height="20" align="left" valign="middle"><span class="tabtxt" title="${activityScore.selfScore.description}"> 								
