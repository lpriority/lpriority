...
<meta charset="UTF-8">
<head>
<link href="resources/css/math_game_1.css" rel="stylesheet" type="text/css" />
...
<script>
	   $(function() {
		...
		var baseClassValues = {c1_text:1, c2_text:2, c3_text:3, c4_text:4};
		var baseColors = {c1_text:"#04e0b5", c2_text:"#04e0b5", c3_text:"#04e0b5", c4_text:"#04e0b5"};
		...
		function getBaseClass(){
			var classNames= ["c1_text","c2_text","c3_text","c4_text"];
			var baseClass = "";
		...
		function validateData(){	
			...
			var totalFranction = "";
			var baseFranction = "";
			for(var i=baseClassValues[baseClass];i<=4;i++){
		...
		function isOnlyColored(className){
			var status = true;
			if(baseClassValues[className]<4){
				var checkColor = "";
		...
		var content ='<div class="circle circle4" style="top:0em;">';
			   for(i=1;i<=32;i++){
				   content+='<li class="c4_sector'+i+'" id="c4c'+i+'_cls" onclick="checkCell(\'c4c'+i+'\')"><span class="c4_text" id="c4c'+i+'">1/32<input type="hidden" id="val:c4c'+i+'" name="val:c4_text" value="1/32" /><input type="hidden" id="sub:c4c'+i+'" name="sub:c4_text" value="done"/></span></li>';
			   }
			   content+='<div class="circle circle3">';
			   for(j=1;j<=16;j++){
				   content+='<li class="c3_sector'+j+'" id="c3c'+j+'_cls" onclick ="checkCell(\'c3c'+j+'\')"><span class="c3_text" id="c3c'+j+'">1/16<input type="hidden" id="val:c3c'+j+'" name="val:c3_text" value="1/16" /><input type="hidden" id="sub:c3c'+j+'" name="sub:c3_text" value="done"/></span></li>';
			   }
			   content+='<div class="circle circle2">';
			   for(k=1;k<=8;k++){
				   content+='<li class="c2_sector'+k+'" id="c2c'+k+'_cls" onclick ="checkCell(\'c2c'+k+'\')"><span class="c2_text" id="c2c'+k+'">1/8<input type="hidden" id="val:c2c'+k+'" name="val:c2_text" value="1/8" /><input type="hidden" id="sub:c2c'+k+'" name="sub:c2_text" value="done"/></span></li>';
			   }
			   content+='<div class="circle circle1">';
			   for(l=1;l<=4;l++){
				   content+='<li class="c1_sector'+l+'" id="c1c'+l+'_cls" onclick ="checkCell(\'c1c'+l+'\')"><span class="c1_text" id="c1c'+l+'">1/4<input type="hidden" id="val:c1c'+l+'" name="val:c1_text" value="1/4" /><input type="hidden" id="sub:c1c'+l+'" name="sub:c1_text" value="done"/></span></li>';
			   }
