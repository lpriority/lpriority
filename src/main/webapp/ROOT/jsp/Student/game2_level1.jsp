...
<body>
	...
	<input type="hidden" id="totalCells" value="39">
<table width="100%">
<tr>
...
<tr><td width="100%" align="center" colspan="2">
	<div id="container">
			<div class="circle circle3">
			  <c:forEach var="index" begin="1" end="27"><input type="hidden" class="pos" id="pos:c3c${index}" value="0" /><input type="hidden" id="ans:c3c${index}" value="1/27" />
				  <li class="c3_sector${index}" id="c3c${index}" name="c3c" onClick="checkFractionsss(this)" >
				      <span id="c3c${index}:" class="c3_text"></span>
				  </li>
			  </c:forEach>
			   <div class="circle circle2">
				  <c:forEach var="index" begin="1" end="9"><input type="hidden" class="pos" id="pos:c2c${index}" value="0" /><input type="hidden" id="ans:c2c${index}" value="1/9" />
