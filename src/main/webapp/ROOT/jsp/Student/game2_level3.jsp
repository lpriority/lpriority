...
$(document).ready(function(){
	  var content ='<div class="circle circle3">';
	   for(j=1;j<=27;j++){
		   content+='<li class="c3_sector'+j+'" id="c3c'+j+'_cls" onclick="checkColorPicker()"><span class="c3_text" id="c3c'+j+'">1/27</span></li>';
	   }
	   content+='<div class="circle circle2">';
	   for(k=1;k<=9;k++){
		   content+='<li class="c2_sector'+k+'" id="c2c'+k+'_cls" onclick="checkColorPicker()"><span class="c2_text" id="c2c'+k+'">1/9</span></li>';
	   }
...
function goForNextGearTest(){
	...
	$.ajax({
		...
		success : function(response) {
				systemMessage("Congratulations! Gear 2 Completed !!");
				$('#mathGameDiv').empty();  
