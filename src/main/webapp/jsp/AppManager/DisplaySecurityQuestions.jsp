...
<body>
	<table>
		...
		<c:forEach items="${securityQuestionsList}" var="securityQuestion">
			<tr>
				<td>${securityQuestion.securityQuestionId}</td>
				<td>${securityQuestion.question}</td>
				<td><a
					href="editSecurityQuestion.htm?id=${securityQuestion.securityQuestionId}"><img
						src="images/Admin/edit_button.png" width="30" height="30"></a></td>
				<td>&nbsp;</td>
				<td><img
						src="images/Admin/delete_button.png" width="40" height="30" onclick="deleteSecQuestion()"></td>
			</tr>
		</c:forEach>
		<tr>
			<td><a href="addSecurityQuestion.htm"><img
