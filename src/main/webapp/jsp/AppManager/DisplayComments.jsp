	...
	<table>
		...
		<c:forEach items="${commentsList}" var="cList">
			<tr>
				...
				<td>${cList.comment}</td>
				<td><a href="editComment.htm?id=${cList.commentId}"><img
						src="images/Admin/edit_button.png" width="30" height="30"></a></td>
				<td>&nbsp;</td>
				<td><img src="images/Admin/delete_button.png" width="40" height="30" onclick="deleteComments()"></td>
			</tr>
		</c:forEach>
		<tr>
			<td><a href="addComment.htm"><img
