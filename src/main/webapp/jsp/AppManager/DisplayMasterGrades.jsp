...
<body>
	<table>
		...
		<c:forEach items="${mgList}" var="mg">
			<tr>
				<td>${mg.masterGradesId}</td>
				<td>${mg.gradeName}</td>
				<td><a href="editMasterGrade.htm?id=${mg.masterGradesId}"><img
						src="images/Admin/edit_button.png" width="30" height="30"></a></td>
				<td>&nbsp;</td>
				<td><img
						src="images/Admin/delete_button.png" width="40" height="30" onclick="deleteMasterGrade()"></td>
			</tr>
		</c:forEach>
		<tr>
			<td><a href="addMasterGrade.htm"><img
