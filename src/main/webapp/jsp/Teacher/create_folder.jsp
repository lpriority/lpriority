                ...
                <tr>
                    <td height="30" colspan="2" align="left" valign="middle">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="480" align="left"><font color="aeboad" size="4"></font>   </td>
                                <td width="112" align="left" valign="middle">            </td>
                                <td width="834" align="right" valign="middle">&nbsp;</td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                            <tr>
                                                <td width="70" height="25" align="left">
                                                   <div class="button_green" align="right" onclick="creatTeacherFolder()">Create</div>
                                                </td>
