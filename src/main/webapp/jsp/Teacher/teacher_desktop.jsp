...
<body>  <div class="main">  
   ...
   <!-- Student Desktop messages -->
						<c:set var="check" value="0"></c:set>
							...
							<c:if test="${litracyNotifyLength gt 0}"> 
							<div id="notificationDiv" style="display:none;">
								<div>
									<i class="fa fa-angle-double-right" style="color: #01b3ca;"></i>&nbsp;&nbsp;<a href="gotoGradeRti.htm" class="notification_title"><b> New tests submitted for grading</b></a>
								</div>
								</div>
							</c:if>	
   ...
   <td width="30%" align="center"><table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<div style="margin-bottom:2em;"></div>
         		   <div class="dashboard-box" style="background:#dee4e6;width:100%;height:220px;">
			        <div class="dashboard-label"><div class="back-side-right"></div><span class="front-side">Reading DashBoard </span></div>
		             <br>
			   		 ...
			   		 <div style="width: 100%;overflow: hidden;height: 180px;font-size:13px;margin-top: 4em;float:left;">
		                  <div>
								 ...
								 <div class="content">
			                                 <ul class="ca-menu">
                      <li>
			                        <a href="goToTeacherRSDD.htm">
			                            <span class="ca-icon"><i class="fa fa-tachometer"></i></span>
			                            <div class="ca-content">
			                                <h3 class="ca-sub">Reading DashBoard &nbsp;</h3>
			                            </div>
			                        </a>
			                    </li>				
                   </ul>
