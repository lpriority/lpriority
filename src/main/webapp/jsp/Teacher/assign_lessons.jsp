...
<body>
				<form:form id="createUnits" name="createUnits" action="assignCurriculum.htm" modelAttribute="createUnits" method="post" >
								...
								<table width="100%" height="30" border="0" cellpadding="0"
									...
									<tr>
										...
										<td width="60" align="left"><select name="gradeId" 
											id="gradeId" class="listmenu" onChange="getGradeClasses();clearDiv(this)"
											required="required">
										...
										<td width="40">
											<labe class="label">Class </labe></td>
										<td width="60" align="left" valign="middle"><select
											required="required" name="classId" class="listmenu"
											onChange="getUnitsByTeacherNAdmin();clearDiv(this)" id="classId">
			...
			<div id="videoDiv">
				<a href="#" onClick="openVideoDialog('teacher','assign_lesson','videoDailog')" class="demoVideoLink"><i class="ion-videocamera" aria-hidden="true" style="font-size:26px;font-weight:bold;color:#e23c00;"></i>&nbsp;video for Assign Lesson</a>
		 	</div>
			</td>
