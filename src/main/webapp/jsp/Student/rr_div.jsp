 ...
 <c:set var="page" value="1" />
		  				    ...
		  				    Number of Pages : ${readRegMaster.numberOfPages}
		   				    Points earned : ${readRegActivityScore.pointsEarned} (pages of the book = ${readRegMaster.readRegPageRange.range} x Activity Value = ${readRegActivityScore.readRegActivity.activityValue } x Rubric value = ${readRegActivityScore.readRegRubric.score} )"></c:set>
										...
										<div class="inline"
											...
											<input type="hidden" id="titCon_${readRegActivityScore.readRegActivityScoreId}" value="${titleContent}" />
											<img
		  				    ...
		  				    Number of Pages : ${readRegMaster.numberOfPages}
		   				    Points earned : ${readRegActivityScore.pointsEarned} (pages of the book = ${readRegMaster.readRegPageRange.range} x Activity Value = ${readRegActivityScore.readRegActivity.activityValue } x Rubric value = ${readRegActivityScore.readRegRubric.score} )"></c:set>
										...
										<div class="inline" id="imgDiv44_${readRegMaster.titleId}_${readRegReview.student.userRegistration.regId}">											<input type="hidden" id="titCon_${readRegMaster.titleId}_${readRegReview.student.userRegistration.regId}" value="${titleContent}" /> --%>
											<input type="hidden" id="titCon_${readRegActivityScore.readRegActivityScoreId}" value="${titleContent}" />
