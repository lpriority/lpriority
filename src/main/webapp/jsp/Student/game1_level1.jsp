...
<link rel="stylesheet" href="resources/css/math_game_1.css">
...
<body>
	...
	<input type="hidden" id="totalCells" value="60">
<table width="100%">
<tr>
...
<tr><td width="100%" align="center" colspan="2">
	<div id="container">
		<div class="circle circle4">
			<c:forEach var="index" begin="1" end="32"><input type="hidden" class="pos" id="pos:c4c${index}" value="0" /><input type="hidden" id="ans:c4c${index}" value="1/32" />
			   <li class="c4_sector${index}"  id="c4c${index}" name="c4c" onClick="checkFractionsss(this)" >
			     <span id="c4c${index}:" class="c4_text"></span>
			   </li>
			 </c:forEach>
			<div class="circle circle3">
			  <c:forEach var="index" begin="1" end="16"><input type="hidden" class="pos" id="pos:c3c${index}" value="0" /><input type="hidden" id="ans:c3c${index}" value="1/16" />
				  <li class="c3_sector${index}" id="c3c${index}" name="c3c" onClick="checkFractionsss(this)" >
				      <span id="c3c${index}:" class="c3_text"></span>
				  </li>
			  </c:forEach>
			   <div class="circle circle2">
				  <c:forEach var="index" begin="1" end="8"><input type="hidden" class="pos" id="pos:c2c${index}" value="0" /><input type="hidden" id="ans:c2c${index}" value="1/8" />
