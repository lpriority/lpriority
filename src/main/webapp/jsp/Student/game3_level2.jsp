...
<script>
	   $(function() {
		...
		$(document).ready(function(){
			   ...
			   for(j=1;j<=18;j++){
				   content+='<li class="c3_sector'+j+'" id="c3c'+j+'_cls" onclick ="checkCell(\'c3c'+j+'\')"><span class="c3_text" id="c3c'+j+'">1/18<input type="hidden" id="val:c3c'+j+'" name="val:c3_text" value="1/18" /><input type="hidden" id="sub:c3c'+j+'" name="sub:c3_text" value="done"/></span></li>';
			   }
			   content+='<div class="circle circle2">';
			   for(k=1;k<=6;k++){
				   content+='<li class="c2_sector'+k+'" id="c2c'+k+'_cls" onclick ="checkCell(\'c2c'+k+'\')"><span class="c2_text" id="c2c'+k+'">1/6<input type="hidden" id="val:c2c'+k+'" name="val:c2_text" value="1/6" /><input type="hidden" id="sub:c2c'+k+'" name="sub:c2_text" value="done"/></span></li>';
			   }
