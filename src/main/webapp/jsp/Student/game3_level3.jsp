...
<link rel="stylesheet" href="resources/css/math_game_3.css">
...
$(document).ready(function(){
	  var content ='<div class="circle circle3">';
	   for(j=1;j<=18;j++){
		   content+='<li class="c3_sector'+j+'" id="c3c'+j+'_cls" onclick="checkColorPicker()"><span class="c3_text" id="c3c'+j+'">1/18</span></li>';
	   }
	   content+='<div class="circle circle2">';
	   for(k=1;k<=6;k++){
		   content+='<li class="c2_sector'+k+'" id="c2c'+k+'_cls" onclick="checkColorPicker()"><span class="c2_text" id="c2c'+k+'">1/6</span></li>';
	   }
	   content+='<div class="circle circle1">';
	   for(l=1;l<=3;l++){
		   content+='<li class="c1_sector'+l+'" id="c1c'+l+'_cls" onclick="checkColorPicker()"><span class="c1_text" id="c1c'+l+'">1/3</span></li>';
	   }
...
function goForNextGearTest(){
	...
	$.ajax({
		...
		success : function(response) {
				systemMessage("Congratulations! Gear 3 Completed !!");
				$('#mathGameDiv').empty();  
