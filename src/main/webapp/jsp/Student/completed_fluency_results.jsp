      ...
      <div style="padding: 2px 5px 2px 5px"><table>
            ...
            <c:forEach items="${studentAssignmentStatusLt}" var="sas" varStatus="status">
                    ...
                    <tr><td width='51'  height='25' align='center' valign='middle'  class='txtStyle'>
	                         <input type="radio" class="radio-design" name="radio" id="studentAssignmentId:${testCount}" onClick="getFluencyReadingQuestions(${sas.assignment.assignmentId},${sas.studentAssignmentId},${sas.assignment.assignmentType.assignmentTypeId})" />
                    ...
                    <td width='111'  align='center' valign='middle' class='txtStyle'><c:out value="${sas.gradedStatus}"></c:out></td> 
