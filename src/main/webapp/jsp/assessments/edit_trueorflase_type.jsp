...
<c:if test="${count > 0}">
	...
	<tr>
		<td width="100" align="left"><span class="tabtxt">Question ${status.count} :</span></td>
		<td width="120" height="40" align="left"><form:textarea path="questionsList.questions[${qNumber}].question" id="question${qNumber}" required="required" cols="50" rows="2" onchange="updateQuestion(${qNumber})"/></td>
		<td width="60"  height="40" align="left" align='left' colspan='3' style='padding-left:1em'>
	...
	<tr>
	    <c:if test="${questionsList.questions[qNumber].answer == 'true'}">
				<c:set var="checked" value="true"></c:set>
		</c:if>
		<td width="100" height="40" valign="top" align="left"></td>
		<td width="120" height="40" valign="top" align="left" style='padding-left:5em'>True&nbsp;<form:radiobutton path="questionsList.questions[${qNumber}].answer" value="true" checked="${checked}" onclick="updateQuestion(${qNumber})"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;False&nbsp;<form:radiobutton path="questionsList.questions[${qNumber}].answer" value="false" onclick="updateQuestion(${qNumber})"/></td>
