...
<title>Welcome to The Learning Priority Inc | Reading Register</title>
...
<div class="row">
  <div class="col-sm-12 text-right" style="margin-top:-30px;"> <a class="urllink" href="downloadFile.htm?fileName=Reading Register Student Guide.pdf" download><i class="fa fa-download" aria-hidden="true" style="font-size: 17px;color:#8e1400;"><span style="font-size: 13px;color:#8e1400;padding:5px;font-weight:bold;">Download</span></i></a> </div>
</div>
<div class="row">
  <div class="col-sm-12 text-center"><span class="mainhead">Reading Register Student Guide</span></div>
...
<div class="row">
  <div class="col-sm-12">
    <div class="text-center"><img src="images/Student/readingregister/step1.PNG"></div>
  </div>
  <div class="col-sm-12">
    <div class="text-center"><img src="images/Student/readingregister/step2.PNG"></div>
  </div>
  <div class="col-sm-12 text-center">
    <p class="subhead">Make sure you submit your activity when you finish!</p>
  </div>
</div>
