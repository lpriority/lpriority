      ...
      <div class="tab-content">
      	<div id="ftui">   
        	<h1>Email Verification</h1>
          		<div>
                	<span><p class="font-style">A Verification code has been  sent to your Email Id. Please check your email account and <br />
                  		Enter the verification code  while doing Registration.</p></span>
              	</div>
              	<div>
              		<span width="100%" height="20" align="center" valign="middle"><a href="index.htm" class="button_green">Home Page</a></span>
              	</div>
       	 </div>
      </div>
	</div> 
