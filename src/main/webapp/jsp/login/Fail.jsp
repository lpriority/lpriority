	...
	<div class="form" style="margin-top:-1em;">
      	<div id="ftui">   
        	<h1>Failed</h1>
              	...
              	<div><p >Please click on below button to go home page. </p></div>
              	<div>
              		<span width="100%" height="20" align="center" valign="middle"><a href="firstTimeUserInfo.htm" class="button_green">First Time User Info</a>&nbsp;&nbsp;&nbsp;<a href="index.htm" class="button_green">Home Page</a></span>
              	</div>
       	 </div>
	</div> 
