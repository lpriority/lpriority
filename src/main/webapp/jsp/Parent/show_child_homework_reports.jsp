...
<c:set var="de" value=""></c:set>
 <c:if test="${fn:length(homeworkReports) > 0}">
 <c:set var="bor" value="0"></c:set>
...
<!--  <table style="padding-top: 2em;"> -->
        <tr><td width='51'  height='25' align='center' valign='middle' class='tabtxt'><b>Select</b> </td>
                  <td width='111'  align='center' valign='middle' class='tabtxt'><b>Class</b> </td>
                  <td width='111'  align='center' valign='middle' class='tabtxt'> <b>Teacher </b></td>  
           ...
           <tr><td>&nbsp;</td></tr>
            ...
            <c:forEach items="${homeworkReports}" var="al">
            
                    <tr><td width='51'  height='25' align='center' valign='middle'  class=''>
                     ...
                     <td width='111'  align='center' valign='middle' class='txtStyle'> <c:out value="${al.assignment.classStatus.section.gradeClasses.studentClass.className}"></c:out></td>
                     <td width='111'  align='center' valign='middle' class='txtStyle'><c:out value="${al.assignment.classStatus.teacher.userRegistration.firstName}"></c:out>&nbsp;
                     <c:out value="${al.assignment.classStatus.teacher.userRegistration.lastName}"></c:out> </td>  
                     <td width='111'  align='center' valign='middle'  class='txtStyle'>${al.assignment.title }</td>
