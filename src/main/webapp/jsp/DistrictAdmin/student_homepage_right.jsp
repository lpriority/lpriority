            		...
            		<div class="sign_in">
            		 <table width="100%">
				        ...
				        <tr><td width="100%" height="30" align="center" >
					 	       <select name="gradeId" id="gradeId" onChange="clear();getStudentsByGradeId('graded');" required="required" class="desktop_select" style="width:70%;border:1px solid #97ced6;color:white;">
