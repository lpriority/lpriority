...
public interface MathAssessmentDAO {
	...
	public boolean assignGameToStudents(List<StudentAssignmentStatus> studentAssignmentList, Assignment assignment, List<MathGameScores> gameScores);
